...
/// Stores ongoing and completed orders. Used by CartScreen (on place order)
/// and OrdersScreen (My Orders). Persists to SharedPreferences.
class OrderProvider extends ChangeNotifier {
  ...
  /// Adds cart items as a new ongoing order. Call when user places order.
