...
class _CartScreenState extends State<CartScreen> {
  ...
  void _showLoginRequiredForCheckout() {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            Icon(Icons.login, color: _primaryPurple, size: 28),
          ...
          TextButton(
            onPressed: () {
              ...
              Navigator.push(
                navigatorContext,
                MaterialPageRoute(
                  builder: (c) => const SignUpScreen(returnToCart: true),
                ),
              ).then((result) {
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.push(
                navigatorContext,
                MaterialPageRoute(
                  builder: (c) => const LoginScreen(returnToCart: true),
                ),
              ).then((result) {
                if (result == true && mounted && navigatorContext.mounted) {
                  _openCheckoutModal();
  ...
  Future<void> _placeOrder(String address) async {
    ...
    OrderProvider.instance.addOngoingOrder(
      items,
      address,
      userEmail: userEmail,
    );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _qtyButton(
                          () => CartProvider.instance.updateQuantity(index, -1),
                          Icons.remove,
                        ),
                        Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildSection(
                        'Payment',
                        _paymentExpanded ? 'COD' : _paymentMethod,
                        () => setState(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    if (selected)
                      Icon(Icons.check_circle, color: _primaryPurple, size: 22),
                  ],
                ),
              ),
            ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                child: _buildField(_phoneController, 'Phone', Icons.phone),
              ),
            ],
          ),
          const SizedBox(height: 12),
